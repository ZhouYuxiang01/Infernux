...
The original Infernux engine README is kept in [`README.md`](README.md). This
file focuses only on the AI-native direction: turning the engine into a runtime
...
| Document | Purpose |
| --- | --- |
| [`README.md`](README.md) | Original Infernux engine README. |
| [`README-zh.md`](README-zh.md) | Original Chinese README. |
| [`README-AI-NATIVE.md`](README-AI-NATIVE.md) | This AI-native modification overview. |
