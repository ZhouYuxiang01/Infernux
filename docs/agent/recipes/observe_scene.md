...
5. `runtime_capture_game_view` when rendered layout, sprite orientation, or camera framing matters
...
- You have a pixel capture when the task depends on what the Game View looks like.
