...
class Infernux:
    ...
    def init_preview_task_system(self, worker_count: int = 1) -> None: ...
    def shutdown_preview_task_system(self) -> None: ...
    def schedule_material_preview_task(self, resource_key: str, mat_file_path: str, stamp: int) -> bool: ...
    def schedule_texture_preview_task(self, resource_key: str, texture_file_path: str, stamp: int,
                                      nearest: bool = False, srgb: bool = False) -> bool: ...
    def pump_preview_tasks(self) -> None: ...
    def get_material_preview_texture_id(self, resource_key: str, expected_stamp: int) -> int: ...
